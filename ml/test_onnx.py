...
def load_model(model_path):
    ...
    print(f"Loaded model with input {input_name} and output {output_name}")
    return session, input_name, output_name

def run_inference(session, input_name, output_name, processed_image):
    # Run the model
...
def draw_bbox(image, bboxes, classes=read_class_names("ml_model/coco.names"), show_label=True):
    """
...
if __name__ == "__main__":
    ...
    for image in get_images_local_folder(folder_path="ml_model/downloaded_images"):
        ...
        image_data = preprocess_image(np.copy(original_image), [input_size, input_size])
